...
int main()
{
    std::vector< std::vector< unsigned>  > gr0 = {
            {0, 2, 0, 6, 0},
            {2, 0, 3, 8, 5},
            {0, 3, 0, 0, 7},
            {6, 8, 0, 0, 9},
    ...
    std::vector<Edge> mst0 = compute_mst(gr0);
    std::cout<<"MST0:"<<std::endl;
    for(Edge e: mst0)
    {
        std::cout<<e.pt1<<" "<<e.pt2<<" "<<e.weight<<std::endl;
    }
    std::vector<unsigned> journey0 = computeTSPJourney(mst0, 0);
    for(unsigned ver: journey0)
    {
        std::cout<<ver<<" ";
    }
    std::cout<<std::endl;

    std::vector< std::vector< unsigned>  > gr1 = { 
	...
	std::vector<Edge> mst1 = compute_mst(gr1);
    std::cout<<"MST1:"<<std::endl;
    for(Edge e: mst1)
    {
        std::cout<<e.pt1<<" "<<e.pt2<<" "<<e.weight<<std::endl;
    }
    std::vector<unsigned> journey = computeTSPJourney(mst1, 0);
    for(unsigned ver: journey)
    {
        std::cout<<ver<<" ";
    }
    std::cout<<std::endl;

    std::vector< std::vector< unsigned>  > gr2 = {
		...
		std::vector<Edge> mst2 = compute_mst(gr2);
        std::cout<<"MST2"<<std::endl;
        for(Edge e: mst2)
        {
            std::cout<<e.pt1<<" "<<e.pt2<<" "<<e.weight<<std::endl;
        }
        std::vector< std::vector< unsigned>  > gr3 = { 
			{ 0, 12, 12, 13, 17, 9, 7, 14, 3, 17},
			{ 12, 0, 8, 8, 8, 18, 19, 5, 15, 8},
			{ 12, 8, 0, 12, 15, 19, 17, 12, 9, 8},
			{ 13, 8, 12, 0, 6, 15, 14, 3, 10, 4},
        ...
        std::vector<Edge> mst3 = compute_mst(gr3);
